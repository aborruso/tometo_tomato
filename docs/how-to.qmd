...
Un JOIN "fuzzy", sfumato, è quello che consente di trovare corrispondenze anche quando i valori non sono esattamente uguali, ma "simili". Ad esempio, potremmo voler considerare come corrispondenti i nomi di città che differiscono per un solo carattere, o che hanno una [distanza di Levenshtein](https://duckdb.org/docs/stable/sql/functions/text#levenshteins1-s2) (numero di operazioni necessarie per trasformare una stringa in un'altra) inferiore a una certa soglia.
...
Ma è l'output non è proprio quello che ci aspettiamo, ovvero le nostre 3 città con i rispettivi codici:
