...
Su dataset grandi, confrontare ogni riga dell'input con ogni riga del riferimento è costoso. Con `--block-prefix N` il confronto avviene solo tra record che condividono la stessa chiave di blocco, costruita concatenando i primi N caratteri delle colonne di join già normalizzate.
...
Suggerimenti per N:
- 2–3: più sicuro su dati “sporchi” (abbreviazioni, apostrofi)
- 3: buon default per city+region
- 4+: pruning più forte su dati puliti; valuta multi‑pass se cala la recall
